    ...
    const cargarDatos = async () => {
      ...
      try {
        ...
        if (fichaInfo && fichaInfo.codigo_ficha) {
          console.log('✅ Usando fichaInfo del sidebar:', fichaInfo);
          setInfoFicha({
            ficha: fichaInfo,
            programa: {
        ...
        console.log('🔍 Obteniendo info de ficha del servicio...');
        const info = await planeacionService.obtenerInfoFichaCompleta(idFicha);
        setInfoFicha(info);
      } catch (error) {
        console.warn('⚠️ Error obteniendo info ficha, usando datos por defecto:', error);
        setInfoFicha({
          ficha: {
            id_ficha: idFicha,
  ...
  const handleTrimestreChange = async (nuevoTrimestre) => {
    ...
    try {
        ...
        rapsDelTrimestre.map(async (rap) => {
          ...
          try {
            ...
            if (!instructorRap || !instructorRap.id_instructor) {
              instructorRap = null;
              console.log(`RAP ${rap.codigo} NO tiene instructor asignado en sábana`);
            }
          } catch (error) {
      ...
      if (rapsAgregadosConInstructor.length > 0) {
        console.log(`✅ Se agregaron ${rapsAgregadosConInstructor.length} RAP(s) con instructores desde la sábana`);
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (resultado.success) {
        setMensajeModal(` Planeación del trimestre ${trimestreSeleccionado} guardada exitosamente con ${rapsAgregados.length} RAP(s)`);
        ...
        <section className="configuracion-section">
          ...
          {trimestreSeleccionado && !cargando && rapsAgregados.length > 0 && (
            <div className="trimestre-info">
              ...
              <div className="info-raps-disponibles">
                <strong>Acción requerida:</strong> Complete todos los formularios de los RAPs listados a continuación para guardar la planeación.
              </div>
            </div>
          )}
          ...
          {trimestreSeleccionado && !cargando && rapsAgregados.length === 0 && (
            <div className="raps-vacios">
              ...
              <p><small>Verifica la asignación de RAPs en el módulo de sábana o selecciona otro trimestre.</small></p>
            </div>
          )}
        ...
        {trimestreSeleccionado && rapsAgregados.length > 0 && (
          <section className="programa-section">
            ...
            <p className="section-description">
              {infoFicha ? 'Datos extraídos automáticamente del sistema' : 'Datos básicos del sistema'} - Formato GFPI-F-134
            </p>
              ...
              {rap.expandido && (
                <div className="rap-form-content">
                  <section className="competencia-section">
                    ...
                    <p className="section-description">
                      Información específica del RAP seleccionado
                    </p>
                    ...
                    <div className="competencia-info">
                      <div className="info-field">
                        ...
                        <div className="info-content">
                          {rap.competencia || 'Desarrollar el sistema que cumpla con los requisitos de la solución informática'}
                        </div>
                      </div>
                      ...
                      <div className="saberes-grid">
                        <div className="info-field">
                          ...
                          <div className="info-content">
                            {rap.saberes_conceptos || 'Principios de programación orientada a objetos, patrones de diseño, metodologías de desarrollo'}
                          </div>
                        </div>
                        ...
                        <div className="info-field">
                          ...
                          <div className="info-content">
                            {rap.saberes_proceso || 'Análisis de requisitos, diseño de arquitectura, implementación, pruebas'}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="duraciones-grid">
                        <div className="campo-estatico">
                          ...
                          <div className="campo-valor-estatico">
                            ...
                            <small className="nota-calculo">
                              (Calculado: {rap.horas_trimestre || 0} horas × 80%)
                            </small>
                          </div>
                        </div>
                        ...
                        <div className="campo-estatico">
                          ...
                          <div className="campo-valor-estatico">
                            ...
                            <small className="nota-calculo">
                              (Calculado: {rap.horas_trimestre || 0} horas × 20%)
                            </small>
                          </div>
                        </div>
                      </div>
